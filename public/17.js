...
const draggableComponent = {
  ...
  created() {
    if (this.list !== null && this.value !== null) {
      _util_helper__WEBPACK_IMPORTED_MODULE_1__["console"].error(
        "Value and list props are mutually exclusive! Please set one or another."
      );
    }

    if (this.element !== "div") {
      _util_helper__WEBPACK_IMPORTED_MODULE_1__["console"].warn(
  ...
  mounted() {
    ...
    const attributes = Object.keys(this.$attrs).reduce((res, key) => {
      res[Object(_util_helper__WEBPACK_IMPORTED_MODULE_1__["camelize"])(key)] = this.$attrs[key];
      return res;
    }, {});
    ...
    this._sortable = new sortablejs__WEBPACK_IMPORTED_MODULE_0___default.a(this.rootContainer, options);
    this.computeIndexes();
  },
  ...
  methods: {
    ...
    updateOptions(newOptionValue) {
      for (var property in newOptionValue) {
        const value = Object(_util_helper__WEBPACK_IMPORTED_MODULE_1__["camelize"])(property);
