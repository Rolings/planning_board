const routes = [
    ...
    {
         path: '/admin/user/:user_id', component: () => import('../components/user/UserComponent'), props: true,
        children: [
            {name: 'Users',path: '', component: () => import('../components/user/UserEditComponent'), props: true}
        ]
    },
   // {name: 'User',path: '/admin/user/:user_id', component: () => import('../components/user/UserEditComponent'), props: true},
    ...
    {name: 'Menu', path: '/admin/menus', component: () => import('../components/setting/menu/MenuComponents'), props: true},
